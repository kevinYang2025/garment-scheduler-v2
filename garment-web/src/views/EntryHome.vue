...
const modules = [
  ...
  { key: 'planManagement', label: '计划管理', icon: '📅', color: '#f5a623', bg: '#fff6e8', desc: '主计划、排程、二次加工',
  { key: 'warehouse', label: '仓库管理', icon: '📦', color: '#34c77b', bg: '#e8faf0', desc: '面料、辅料、裁片、成品' },
  { key: 'cutting-dispatch', label: '报工管理', icon: '📝', color: '#a78bfa', bg: '#f3eeff', desc: '裁剪、印花、刺绣、缝制报工' },
