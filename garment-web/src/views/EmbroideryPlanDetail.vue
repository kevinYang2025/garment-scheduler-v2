<script setup>
// embroidery 排程详情(使用共享 composable,详见 useSecPlanDetail.js)
import { ref } from 'vue'
...
} = useSecPlanDetail('embroidery')

// [2026-06-20] supervisor 跨车间拦截:只能编辑本车间的 actual
const auth = useAuthStore()
function canEditActualCell(row) {
  return canEditActual({ ...row, secondary_type: 'embroidery', workshop: 'embroidery' }, auth.user)
}
...
function openCreate() {
  createForm.value = { style_no: '', product_name: '', color: '', size_spec: '', plan_qty: 0, embroidery_start: '', embroidery_end: '' }
  // 起止日期默认今天
  createForm.value.embroidery_start = createForm.value.embroidery_start || todayLocal()
  createForm.value.embroidery_end = createForm.value.embroidery_end || todayLocal()
...
async function customConfirmImport() {
  ...
  try {
      ...
      // default: importSchedule('secondary', ...)
...
<template>
  <div class="embroidery-detail">
    ...
    <el-form :model="createForm" label-width="90px" size="small">
      <el-row :gutter="12"><el-col :span="12"><el-form-item label="款号"><el-input v-model="createForm.style_no" /></el-form-item></el-col><el-col :span="12"><el-form-item label="品名"><el-input v-model="createForm.product_name" /></el-form-item></el-col></el-row><el-row :gutter="12"><el-col :span="12"><el-form-item label="颜色"><el-input v-model="createForm.color" /></el-form-item></el-col><el-col :span="12"><el-form-item label="尺码"><el-input v-model="createForm.size_spec" /></el-form-item></el-col></el-row><el-row :gutter="12"><el-col :span="12"><el-form-item label="原单量"><el-input-number v-model="createForm.plan_qty" :min="0" :step="1" style="width:100%" /></el-form-item></el-col><el-col :span="12"><el-form-item label="刺绣上线"><el-input v-model="createForm.embroidery_start" type="date" /></el-form-item></el-col></el-row><el-row :gutter="12"><el-col :span="12"><el-form-item label="刺绣下线"><el-input v-model="createForm.embroidery_end" type="date" /></el-form-item></el-col></el-row>
    </el-form>
    <template #footer>
...
<style scoped>
.embroidery-detail { display: flex; flex-direction: column; height: 100%; min-height: 0; }
