<script setup>
// printing 排程详情(使用共享 composable,详见 useSecPlanDetail.js)
import { ref } from 'vue'
...
} = useSecPlanDetail('printing')

// [2026-06-20] supervisor 跨车间拦截:只能编辑本车间的 actual
const auth = useAuthStore()
function canEditActualCell(row) {
  return canEditActual({ ...row, secondary_type: 'printing', workshop: 'printing' }, auth.user)
}
