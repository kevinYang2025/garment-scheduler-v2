<script setup>
// ironing 排程详情(使用共享 composable,详见 useSecPlanDetail.js)
import { ref } from 'vue'
...
function openCreate() {
  createForm.value = { style_no: '', product_name: '', color: '', size_spec: '', plan_qty: 0, ironing_start: '', ironing_end: '' }
  // 起止日期默认今天
  ...
  createForm.value.ironing_start = createForm.value.ironing_start || todayLocal()
  createForm.value.ironing_end = createForm.value.ironing_end || todayLocal()
...
<style scoped>
.ironing-detail { display: flex; flex-direction: column; height: 100%; min-height: 0; }
